...
void USART_Configuration(USARTn *usartn, uint32_t baudrate, uint8_t wordlength, uint8_t over8, uint8_t paritycontrol, uint8_t paritytype)
{
    ...
    {
        RCC_EnablePeripheralClock(CLOCK_USART1, _rcc);
    ...
    {
        RCC_EnablePeripheralClock(CLOCK_USART2, _rcc);
    ...
    {
        RCC_EnablePeripheralClock(CLOCK_USART3, _rcc);
    ...
    {
        RCC_EnablePeripheralClock(CLOCK_USART6, _rcc);
    ...
    {
        RCC_EnablePeripheralClock(CLOCK_UART4, _rcc);
    ...
    {
        RCC_EnablePeripheralClock(CLOCK_UART5, _rcc);
...
*******************************************************************************
*/
void USART_SendData(USARTn *usartn, uint8_t *pData, uint16_t Size)
{
    uint16_t data_send;
    while (Size > 0)
    {
